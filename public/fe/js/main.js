    ...
    */
    ...
    function daterangepickerInit() {
      ...
      $('input[name="datetimes"]').daterangepicker(
        {
          timePicker: true, // Active la sélection de l'heure
          timePicker24Hour: true, // Format 24h (optionnel)
          timePickerSeconds: false, // Si tu veux aussi les secondes
          locale: {
            format: 'YYYY-MM-DD HH:mm' // Format avec heure
          },
        ...
        function (start, end, label) {
          let cs_start_date = start.format('YYYY-MM-DD HH:mm').toString();
          let cs_end_date = end.format('YYYY-MM-DD HH:mm').toString();
