				...
				<div>
					...
					@csrf
						<div class="row g-3 align-items-center">
							...
							<div class="col-md-3">
								...
								<div class="position-relative">
									<!-- <input 
										...
										class="cs_datetimes_start form-control"
										value="{{ $defaultStart->format('Y-m-d\TH:i') }}"
										style="background-color: #5B4B41; color: white; border: 1px solid black;" /> -->
							...
							<div class="col-md-3">
								...
								<div class="position-relative">
									<!-- <input 
										...
										class="cs_datetimes_end form-control"
							...
							<!-- Âge conducteur -->
							<div class="col-md-3">
								<label for="age_conducteur" class="form-label text-white">Âge Du Conducteur</label>
								<div class="position-relative">
									<select
										id="age_conducteur"
										name="age_conducteur"
										...
										<option value="" disabled selected>Âge du conducteur</option>
										<script>
